...
python -m myia_utils.update_env environment-cpu.yml -p cpu-extras.conda -o environment-cpu.yml
python -m myia_utils.update_env environment-gpu.yml -p gpu-extras.conda -o environment-gpu.yml
