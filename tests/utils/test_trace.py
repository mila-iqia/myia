...
def sleep():
    tracer().emit_dream(good=True, setting="home", action="throwing cakes")
    tracer().emit_dream(
        good=False, setting="high school", feeling="not this crap again"
    )
...
def test_focus():
    ...
    assert tr.d == {"fruit": {"apple", "banana"}, "ripe": {True}}
