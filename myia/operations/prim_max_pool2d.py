...
def bprop_max_pool2d(
    input, kernel_size, stride, padding, dilation, ceil_mode, out, dout
):
    """Backpropagator for `max_pool2d`."""
    gI = max_pool2d_grad(
        input, kernel_size, stride, padding, dilation, ceil_mode, dout
    )
    return (
        gI,
